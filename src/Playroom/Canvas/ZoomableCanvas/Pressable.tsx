...
export interface PressableProps {
  ...
  readonly onCapturePressCancelled?: (
    pressableUnderlyingElement: HTMLElement
  ) => void;
  /**
...
> {
    ...
    return (
      ...
      >
        {typeof this.props.children === 'function'
          ? (this.props.children as any)(this.state)
          : this.props.children}
      </div>
    );
  }
  ...
  private handleCapturePressMove = (
    ...
    if (this.divRef.current && this.panStartingCoordinates) {
      this.props.onCapturePressMove?.(
        coordinates,
        this.divRef.current,
        this.panStartingCoordinates
      );
    }
  };
